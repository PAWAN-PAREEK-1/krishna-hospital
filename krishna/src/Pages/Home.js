       ...
       <div className="main-index">
          ...
          <div className="hero-index">
                <div className="hero-left">
                  ...
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam nec sapien ut felis finibus efficitur non id libero. Donec dignissim ornare enim.</p>
                 <a href=""><div className="all-btn">
                    <h4>Make an appointment <img src={play} alt="" /></h4>
                  </div></a>
